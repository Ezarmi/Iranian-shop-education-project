                ...
                if (
                    ...
                    <table style="width: 100%;" border="0" style="margin-left:auto;margin-right:auto;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" style="text-align: right; background-color: lightgray;" id="pro_name"
                                    name="pro_name" value="<?php echo ($row['pro_name']); ?>" readonly />
                            </td>
                        </tr>

                        <tr>
                            <td>تعداد با مقدار درخواستی <span style="color: red;">*</span></td>
                            <td>
                                <input type="text" style="text-align: left;" id="pro_qty" name="pro_qty"
                                    onchange="calc_price();" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" style="text-align: left; background-color: lightgray;" id="pro_price"
                                    name="pro_price" value="<?php echo ($row['pro_price']); ?>" readonly /> ریال
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" style="text-align: left; background-color: lightgray;" id="email"
                                    name="email" value="<?php echo ($user_row['email']); ?>" readonly />
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                آدرس دقیق پستی جهت دریافت محصول
                                <span style="color: red;">
                                    *
                                </span>
                            </td>
                            <td>
                                <textarea style="text-align: right; font-family:tahoma;" id="address" name="address"
                                    cols="30" rows="3" wrap="virtual"></textarea>
                            </td>
                        </tr>
                    ...
                    <table>
                        <tr>
                            <td style="border-style: dotted dashed; vertical-align: top;width:33%;">
                                ...
                                <img src="assets/images/products/<?php echo ($row['pro_image']); ?>" width="250px"
                                    height="120px" />
                                <br />
                                قیمت واحد :
