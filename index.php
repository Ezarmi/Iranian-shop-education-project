        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <td style="border-style: dotted dashed;vertical-align: top;width: 33%;">
                ...
                <a href="product_detail.php?id=<?php echo ($row['pro_code']) ?>">
                    <img src="assets/images/products/<?php echo ($row['pro_image']) ?>" width="250px" height="150px" />
                </a>
                <br />
                قیمت :
                ...
                <br /><br />
                <b><a href="product_detail.php?id=<?php echo ($row['pro_code']) ?>" style="text-decoration: none;">توضیحات
                        تکمیلی و
                        خرید</a></b>
            </td>
            <?php
